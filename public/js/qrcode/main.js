...
(function(undefined) {
    ...
    var args = {
        ...
        resultFunction: function(res) {
            ...
            scannedQR[txt] = '<input type="text" value="'+res.code+'">'+res.code;
            var micapa = document.getElementById('formulario');
    micapa.innerHTML= '<input type="text" value="'+res.code+'" name="option" /><input type="text" value="introduce" name="task" />';
        },
